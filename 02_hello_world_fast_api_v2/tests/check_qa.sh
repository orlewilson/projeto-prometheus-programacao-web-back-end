...
pylint ../hello_world_fast_api_v2/ --output-format=parseable:../reports/lint_report.txt

pylint ../hello_world_fast_api_v2/ --output-format=json:../reports/lint_report.json
