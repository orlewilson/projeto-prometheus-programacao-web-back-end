...
pylint ../hello_world_fast_api_v3/ --output-format=parseable:../reports/lint_report.txt

pylint ../hello_world_fast_api_v3/ --output-format=json:../reports/lint_report.json
