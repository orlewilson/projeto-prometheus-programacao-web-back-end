...
from lista_supermercado.main import app
...
def test_obter_produto_ausente():
...
def test_adicionar_produto_sem_body():
...
def test_atualizar_produto_ausente():
