...
pylint ../lista_supermercado_mysql/ --output-format=parseable:../reports/lint_report.txt

pylint ../lista_supermercado_mysql/ --output-format=json:../reports/lint_report.json
